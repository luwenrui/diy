    ...
    window.lumise = {
            ...
            controls: {
                calcCoords: function (absolute) {
                    var theta = this.angle * (Math.PI / 180),
                        ...
                        _angle =
                            currentWidth > 0
                                ? Math.atan(currentHeight / currentWidth)
                                : 0,
        ...
        objects: {
            events: {
                ...
                'object:rotating': function (opts) {
                    ;[0, 45, 90, 135, 180, 225, 270, 315, 360].map(function (
                        a
                    ) {
                    ...
                    lumise.get
                        ...
                        .attr({
                            'data-value': Math.round(opts.target.angle) + 'º',
                        })
                },
                ...
                'mouse:down': function (opts) {
                    ...
                    if (
                        ...
                        objs.map(function (o) {
                            if (
                                ...
                                var img_in = stage.canvas
                                    .getObjects()
                                    .filter(function (im) {
                                        return im.imagebox == o.id
                                    })
                                if (img_in.length > 0) {
                                    stage.canvas.setActiveObject(
                                        img_in[img_in.length - 1]
                                    )
                                    opts.target = img_in[img_in.length - 1]
                                    stage.canvas._setupCurrentTransform(
                                        opts.e,
                                        opts.target
                                    )
                                }
                    ...
                    if (opts.target !== null) {
                        ...
                        if (opts.target.group_pos) {
                            ...
                            if (
                                Object.keys(lumise.ops.original_pos).length ===
                                1
                            ) {
                    ...
                    if (opts.target === null) {
                        ...
                        objs.map(function (o) {
                            if (
                                ...
                                if (
                                    opts.e.layerX >
                                        xx - (zoom * o.boxbtn[0]) / 4 &&
                                    opts.e.layerX <
                                        xx + (zoom * o.boxbtn[0]) / 4 &&
                                    opts.e.layerY >
                                        yy - (zoom * o.boxbtn[1]) / 4 &&
                                    opts.e.layerY <
                                        yy + (zoom * o.boxbtn[1]) / 4
                                ) {
                                    if (o.stroke != 'red') {
                    ...
                    if (lumise.ops.auto_snap === true) {
                        var el = {
                                top:
                                    ...
                                    lumise.ops.downon.height *
                                        lumise.ops.downon.scaleY *
                                        0.5,
                                left:
                                    lumise.ops.downon.left -
                                    lumise.ops.downon.width *
                                        lumise.ops.downon.scaleX *
                                        0.5,
                                height:
                                    lumise.ops.downon.height *
                                    lumise.ops.downon.scaleY,
                            ...
                            stage.canvas.getObjects().map(function (obj) {
                                if (
                                    ...
                                    ob = {
                                        top:
                                            obj.top -
                                            obj.height * obj.scaleY * 0.5,
                                        left:
                                            obj.left -
                                            obj.width * obj.scaleX * 0.5,
            ...
            qrcode: function (text, color, callback) {
                ...
                fabric.Image.fromURL(canvas.toDataURL(), function (image) {
                    ...
                    image.set({
                        left:
                            stage.limit_zone.left + stage.limit_zone.width / 2,
                        top: stage.limit_zone.top + stage.limit_zone.height / 2,
                        width: stage.limit_zone.width * 0.7,
                        height:
                            image.height *
                            ((stage.limit_zone.width * 0.7) / image.width),
                        fill: color,
                ...
                image: function (ops, callback) {
                    ...
                    var stage = lumise.stage(),
                        ...
                        do_replace =
                            ...
                            localStorage.getItem('LUMISE-REPLACE-IMAGE') ==
                                'true'
                    ...
                    img.onload = function () {
                            ...
                            if (ibx !== null && !do_replace) {
                                ...
                                if (ops.width > stage.limit_zone.width * 0.85) {
                                    ops.height =
                                        ...
                                        0.85 *
                                        (ops.height / ops.width)
                                    ops.width = stage.limit_zone.width * 0.85
                                }
                                if (
                                    ops.height >
                                    stage.limit_zone.height * 0.85
                                ) {
                                    ops.width =
                        ...
                        image.set(
                            $.extend(
                                {
                                    left:
                                        stage.limit_zone.left +
                                        stage.limit_zone.width / 2,
                                    top:
                                        stage.limit_zone.top +
                                        stage.limit_zone.height / 2,
                                    width: ops.width,
                                    height: ops.height,
                                },
                                ops
						...
						*/
                        ...
                        if (ops.filters && ops.filters.length > 0) {
                            ...
                            image.applyFilters(
                                stage.canvas.renderAll.bind(stage.canvas)
                            )
                        }
                ...
                'text-fx': function (ops, callback) {
                    ...
                    fabric.Image.fromURL(
                        ...
                        function (image) {
                            ...
                            var cdata = lumise.fn.bridgeText(
                                image._element,
                                ops['bridge']
                            )
                ...
                svg: function (ops, callback) {
                    ...
                    var donow = function (ops) {
                        if (
                            ...
                            ops.src =
                                'data:image/svg+xml;base64,' + btoa(wrp.html())
                        ...
                        fabric.loadSVGFromURL(
                            ...
                            function (objects, options) {
                                ...
                                var shape = fabric.util.groupSVGElements(
                                        objects,
                                        options
                                    ),
                                ...
                                if (ops.height === undefined) {
                                    ...
                                    if (
                                        ops.scaleX == 1 &&
                                        ops.width > editzone.width
                                    ) {
                                        ops.scaleX =
                                            (editzone.width * 0.8) / ops.width
                                        ops.scaleY =
                                            (editzone.width * 0.8) / ops.width
                                    }
                                }
                    ...
                    if (
                        /*ops.paths === undefined && */ ops.src.indexOf(
                            'http'
                        ) === 0
                    ) {
                        $.ajax({
                    ...
                    ops = $.extend(
                        {
                            ...
                            button:
                                lumise.data.assets +
                                'assets/images/imagebox-btn.png',
                            imagebox: '',
                        },
                        ops,
                        true
        ...
        design: {
            events: function () {
                var onInput = function (e) {
                        var c = lumise.stage().canvas,
                            ...
                            ratio =
                                parseFloat(this.getAttribute('data-ratio')) ||
                                1,
                            val = showInput(e, this)

                        if (callback) {
                            if (lumise.design.nav.callback[callback])
                                lumise.design.nav.callback[callback](
                                    this,
                                    e,
                                    ratio
                                )
                    ...
                    showInput = function (e, el) {
                        ...
                        var val = el.value,
                            ...
                            ratio =
                                parseFloat(el.getAttribute('data-ratio')) || 1
                        ...
                        if (
                            el.parentNode.getAttribute('data-range') == 'helper'
                        )
                ...
                lumise.trigger({
                    ...
                    events: {
                        'input[type="range"][data-view="lumise"]:input':
                            showInput,
                        'input[type="range"][data-action]:input, input[type="range"][data-callback]:input':
                            onInput,
                        'input[type="range"][data-callback="textFX"]:change':
                            'textFX',
                        ...
                        '#lumise-uploads div[data-tab="internal"]:scroll':
                            'images_more',
                        ...
                        'input#lumise-fill:input,input#lumise-fill:change':
                            'fillColor',
                        ...
                        'li[data-tool="arrange"] button[data-arrange]':
                            'doArrange',
                        '.lumise-more-fonts': 'load_fonts',
                        '#lumise-fonts': 'select_font',

                        '#lumise-upload-form input[type="file"]:change':
                            function () {
                        ...
                        '#lumise-designs-search input:input':
                            'saved_designs_search',
                        ...
                        'a[data-view="cart-details"]':
                            lumise.render.cart_details,
                    },
                    ...
                    leftNav: function (e) {
                        ...
                        if (tab == 'drawing') {
                            ...
                            if (
                                ...
                                $('#lumise-external-images iframe').each(
                                    function () {
                        ...
                        $('#lumise-left [data-view="preactive"]').removeAttr(
                            'data-view'
                        )
                        $(this)
                            .addClass('active')
                        ...
                        $('#lumise-' + this.getAttribute('data-tab')).addClass(
                            'active'
                        )
                    ...
                    stages: function (e) {
                        ...
                        if (e.target.id == 'lumise-stage-nav' && prev) {
                            wrp.removeClass('preview-designs').removeClass(
                                'stages-expand'
                            )
                            wrp.find('li[data-stage].active').removeClass(
                                'active'
                            )
                            wrp.find(
                                'li[data-stage="' + lumise.current_stage + '"]'
                            ).addClass('active')
                            return
                        }
                    ...
                    upload_nav: function (e) {
                        ...
                        wrp.find(
                            'header button.active, div[data-tab].active'
                        ).removeClass('active')
                    ...
                    templates_more: function (e) {
                        ...
                        if (
                            ...
                            lumise.get
                                .el('templates-list')
                                .append(
                                    '<i class="lumise-spinner white x3 mt1 mb1"></i>'
                                )
                    ...
                    shapes_more: function (e) {
                        ...
                        if (
                            ...
                            lumise.get
                                .el('shapes')
                                .append(
                                    '<i class="lumise-spinner white x3 mt3 mb1"></i>'
                                )
                    ...
                    dragPop: function (e) {
                        ...
                        if (el.dragSetup === undefined) {
                            $(document)
                                .on('mousemove', function (e) {
                                    if (
                                        !el.dragging ||
                                        lumise.e.tools.hasClass('minisize')
                                    )
                                        return
                        ...
                        el.rect = {
                            left:
                                lumise.e.tools.offset().left -
                                rect.left -
                                scroll.left,
                            top:
                                lumise.e.tools.offset().top -
                                rect.top -
                                scroll.top,
                            clientX: e.clientX,
                            clientY: e.clientY,
                    ...
                    topTools: function (e) {
                        ...
                        if (
                            (!act ||
                                $(e.target).closest('[data-view="sub"]')
                                    .length > 0) &&
                            (e.target.className.toString().indexOf('close') ===
                                -1 ||
                    ...
                    position: function (e) {
                        ...
                        if (
                            ...
                            var imb = stage.canvas
                                .getObjects()
                                .filter(function (o) {
                                    return (
                                        o.type == 'imagebox' &&
                                        o.id == active.imagebox
                                    )
                                })
                            if (imb.length > 0)
                                limit = {
                        ...
                        if (a && a.fill !== this.value) {
                            if (
                                ...
                                lumise.get
                                    ...
                                    .css({
                                        'border-bottom':
                                            '3px solid ' + this.value,
                                    })
                                a.set('fill', this.value)

                                if (
                                    a._element &&
                                    a._element.src.indexOf(
                                        'data:image/svg+xml;base64'
                                    ) > -1
                                ) {
                                    var svg = lumise.fn.fill_svg(
                                        a._element.src,
                                        this.value
                                    )
                    ...
                    enableCurved: function (e) {
                        ...
                        if (this.checked && active.type == 'i-text') {
                            ...
                            newobj = new fabric.CurvedText(
                                active.getText().trim(),
                                props
                            )
                        } else if (
                            !this.checked &&
                            active.type == 'curvedText'
                        ) {
                            props = active.toObject(lumise.ops.export_list)
                    ...
                    text_effect: function (e) {
                        ...
                        if (effect == 'curved') {
                            ...
                            if (effect == 'normal')
                                return lumise.fn.switch_type(
                                    lumise.objects.text(props)
                                )
                    ...
                    textFX: function (el, e, ratio) {
                        ...
                        if (el.target) {
                            el = this
                            ratio =
                                parseFloat(this.getAttribute('data-ratio')) || 1
                            ev = 'change'
                        }
                    ...
                    strokeColor: function (e) {
                        ...
                        if (
                            stk.color &&
                            typeof stk.color.fromString == 'function'
                        )
                    ...
                    doArrange: function (e) {
                        ...
                        if (this.getAttribute('data-arrange') == 'forward') {
                            ...
                            this.getAttribute('data-arrange') == 'back'
                        ) {
                            if (
                    ...
                    load_fonts: function () {
                        ...
                        $('#lumise-lightbox iframe').on('load', function () {
                            ...
                            $(
                                '#lumise-lightbox span[data-view="loading"]'
                            ).remove()
                        })
                    },
                    ...
                    select_font: function (e) {
                        ...
                        if (family) {
                            ...
                            if (e.target.getAttribute('data-source')) {
                                ...
                                fonts = JSON.parse(
                                    localStorage.getItem('LUMISE_FONTS')
                                )
                                if (fonts[encodeURIComponent(family)])
                                    active.set({
                                        font: fonts[encodeURIComponent(family)],
                                    })
                            }
                    ...
                    bug_submit: function (e) {
                        var wrp = lumise.get.el('bug'),
                            content = wrp
                                .find('textarea[data-id="report-content"]')
                                .val()
                        ...
                        content = btoa(
                            encodeURIComponent(content.substr(0, 1500))
                        )
                        ...
                        lumise.post(
                            ...
                            function (res) {
                                ...
                                setTimeout(function () {
                                    wrp.removeAttr('data-view')
                                    wrp.find(
                                        'textarea[data-id="report-content"]'
                                    ).val('')
                                }, 10000)
                            }
                        )
                    ...
                    saved_designs: function (e) {
                        ...
                        let is_save =
                            $('#lumise-saved-designs').attr('is') == 'save'
                            ...
                            case 'edit':
                                if (id == 'new' || is_save) {
                                    ...
                                    Object.keys(
                                        ...
                                        Object.keys(
                                            lumise.cart.printing.states_data[s]
                                        ).map(function (d) {
                                            if (
                                                typeof lumise.cart.printing
                                                    .states_data[s][d] ==
                                                    'number' &&
                                                lumise.cart.printing
                                                    .states_data[s][d] !== 0
                                            )
                                ...
                                lumise.indexed.get(id, 'dumb', function (res) {
                                    if (res !== null) {
                                        lumise.fn.set_url('cart', null)
                                        lumise.ops.my_designs[id].stages =
                                            res.stages
                                        lumise.fn.edit_design(
                                            lumise.ops.my_designs[id]
                                        )
                                    } else {
                                        lumise.fn.notice(
                                            lumise.i(166),
                            ...
                            case 'import':
                                ...
                                if (
                                    ...
                                    lumise.get
                                        ...
                                        .data({ addEvent: true })
                                        .on('change', function () {
                                            lumise.design.my_designs['import'](
                                                this.files[0]
                                            )
                                        })
                                }
                    ...
                    doPrint: function (e) {
                        ...
                        // console.log(this.getAttribute('data-dp'));
                        switch (this.getAttribute('data-dp')) {
                            case 'format':
                                var inps = [
                                    ...
                                    size =
                                        stage !== undefined &&
                                        stage.size !== undefined
                                            ? stage.size
                                            : ''

                                inps = $('#lumise-print-nav').find(
                                    inps.join(',')
                                )
                                ...
                                if (format == 'png') {
                                    if (size !== '') {
                                        ...
                                        if (
                                            ...
                                            $('#lumise-print-nav')
                                                .find(
                                                    'li[data-row="csize"],li[data-row="unit"]'
                                                )
                                                .show()
                                        }
                                    } else inps.show()
                                    $(
                                        '#lumise-print-nav lumise-btn[data-func="print"]'
                                    ).show()
                                } else {
                                    inps.hide()
                                    $(
                                ...
                                if (format == 'pdf')
                                    $('#lumise-print-nav')
                                        .find(
                                            'li[data-row="full"], li[data-row="cropmarks"]'
                                        )
                                        .show()
                                else
                                    $('#lumise-print-nav')
                            ...
                            case 'unit':
                                ...
                                if (unit == 'inch') {
                                    ...
                                    val[0] = (val[0] * 28.346).toFixed(2)
                                    val[1] = (val[1] * 28.346).toFixed(2)
                                }

                                val = val.join(' x ')

                                inp.val(val)
                                // console.log(val);exit;
                                pcfg.csize = val
                            ...
                            case 'size':
                                ...
                                if (unit == 'inch') {
                                    ...
                                    val[0] = (val[0] * 28.346).toFixed(0)
                                    val[1] = (val[1] * 28.346).toFixed(0)
                                }
                        ...
                        if (this.tagName == 'BUTTON') {
                            var format = $(
                                ...
                                include_base =
                                    $('#lumise-print-base').prop('checked'),
                                full = $('#lumise-print-full').prop('checked'),
                                overflow = $('#lumise-print-overflow').prop(
                                    'checked'
                                ),
                                stage = lumise.stage(),
                    ...
                    doShare: function (e) {
                        ...
                        var share_history = localStorage.getItem(
                                ...
                                function (res) {
                                    ...
                                    if (res.result.length > 0) {
                                        ...
                                        res.result.map(function (s) {
                                            ...
                                            share_url +=
                                                'product_base=' + s.product
                                            share_url +=
                                                '&product_cms=' + s.product_cms
                        ...
                        switch (func) {
                            ...
                            case 'create-link':
                                ...
                                Object.keys(lumise.data.stages).map(function (
                                    ...
                                    if (
                                        typeof lumise.data.stages[s] !==
                                            'undefined' &&
                                        typeof lumise.data.stages[s].canvas !==
                                            'undefined'
                                    ) {
                                        var canvas =
                                ...
                                if (
                                    ...
                                    has_design <
                                        Object.keys(lumise.data.stages).length
                                ) {
                                ...
                                var wrp = $(e.target).closest(
                                        '#lumise-shares-wrp'
                                    ),
                                    data = lumise.fn.export('share'),
                                    screenshot =
                                        data.stages[Object.keys(data.stages)[0]]
                                            .screenshot
                                ...
                                formData.append(
                                    'aid',
                                    lumise.fn.get_cookie('lumise-AID')
                                )
                                formData.append(
                                    'label',
                                    $('#lumise-share-link-title').val()
                                ...
                                $.ajax({
                                    ...
                                    success: function (res, status) {
                                        ...
                                        if (res.success === 0) {
                                            ...
                                            share_url +=
                                                'product_base=' + res.product
                                            if (
                                                res.product_cms !== null &&
                                                res.product_cms !== ''
                                            )
                                                share_url +=
                                                    '&product_cms=' +
                ...
                $('#lumise-left #lumise-text *[draggable="true"]').each(
                    function () {
                ...
                $(document)
                    .on('click', function (e) {
                        ...
                        if (
                            !$(e.target).is(except) &&
                            $(e.target).closest('#lumise-stage-nav').length ===
                                0 &&
                        ...
                        if (
                            ...
                            if (
                                lumise.e.main.find('li[data-tool].active')
                                    .length > 0
                            )
                                lumise.fn.navigation('clear')
                    ...
                    .on('keydown', function (e) {
                        if (
                            ['TEXTAREA', 'INPUT'].indexOf(e.target.tagName) >
                                -1 ||
                            ...
                            switch (e.keyCode) {
                                ...
                                case 90:
                                    if (e.shiftKey === false)
                                        ...
                                        return lumise.actions.do('ctrl-shift-z')
                                    break
                                case 61:
                ...
                if (pcfg && pcfg !== '') {
                    ...
                    if (pcfg.format !== undefined)
                        $(
                            '#lumise-print-nav input[data-format="' +
                                pcfg.format +
                                '"]'
                        )
                            .prop({ checked: true })
                    ...
                    if (pcfg.unit !== undefined)
                        $(
                            '#lumise-print-nav input[data-unit="' +
                                pcfg.unit +
                                '"]'
                        )
                            .prop({ checked: true })
                    ...
                    [
                        ...
                        function (e) {
                            ...
                            if (window.is_first_text === undefined) {
                                ...
                                $(
                                    '#lumise-text-tools li[data-tool="spacing"]'
                                ).trigger('click')
                            }
            ...
            layers: {
                ...
                arrange: function () {
                    ...
                    if (
                        ...
                        btn.filter('[data-arrange="back"]').removeClass(
                            'disabled'
                        )
                    else
                    ...
                    if (
                        ...
                        btn.filter('[data-arrange="forward"]').removeClass(
                            'disabled'
                        )
                    else
                        btn.filter('[data-arrange="forward"]').addClass(
                            'disabled'
                        )
                },
                    ...
                    var L = lumise.design.layers,
                        events = {
                            ...
                            dragend: function (e) {
                                ...
                                L.eldrag.parentNode.removeAttribute(
                                    'data-holder'
                                )
                ...
                build: function () {
                    ...
                    stage.canvas.getObjects().map(function (o) {
                        ...
                        layer.find('span.layer-name').on('keyup', function (e) {
                            $(this.parentNode).data('canvas').name =
                                this.innerText
            ...
            my_designs: {
                import: function (file) {
                    ...
                    if (
                        lumise.cliparts.uploads[file.lastModified] === undefined
                    ) {
                        ...
                        reader.addEventListener(
                            ...
                            function () {
                                try {
                                    var data = JSON.parse(
                                        decodeURIComponent(this.result)
                                    )
                                } catch (ex) {
                                    return lumise.fn.notice(
                                        ex.message,
            ...
            nav: {
                callback: {
                            ...
                            save: function (crop) {
                                ...
                                if (active) {
                                    var _e = el.get(0),
                                        ...
                                        w =
                                            img.naturalWidth *
                                            (_e.offsetWidth / _c.offsetWidth),
                                        h =
                                            img.naturalHeight *
                                            (_e.offsetHeight / _c.offsetHeight),
                                        iw =
                                            active.width *
                                            (_e.offsetWidth / _c.offsetWidth),
                                        ih =
                                    ...
                                    ctx.drawImage(
                                        img,
                                        -_e.offsetLeft *
                                            (img.naturalWidth / _c.offsetWidth),
                                        -_e.offsetTop *
                                            (img.naturalHeight /
                                                _c.offsetHeight),
                                        img.naturalWidth,
                    ...
                    qrcode: function () {
                        ...
                        new jscolor.color(
                            lumise.fn.q(
                                '#lumise-create-qrcode input[name="color"]'
                            ),
                            {}
                        )
                        $('#lumise-create-qrcode button').on(
                            'click',
                            function (e) {
                                var text = lumise.fn.q(
                                        '#lumise-create-qrcode input[name="text"]'
                                    ).value,
                                    color = lumise.fn.q(
                                        '#lumise-create-qrcode input[name="color"]'
                                    ).value
                                ...
                                lumise.get
                                    .el(
                                        'left .lumise-left-nav li[data-tab="layers"]'
                                    )
                                    .trigger('click')
                            }
                        )
                        lumise.fn
                            .q('#lumise-create-qrcode input[name="text"]')
                            .focus()
                    },
                    ...
                    proceed: function (el, e) {
                        var printings = lumise.get
                                .el('cart-wrp')
                                .find(
                                    'input[name="printing"].lumise-cart-param'
                                ),
                    ...
                    svg: function (el, e) {
                        if (
                            ...
                            e.target.getAttribute('data-func') == 'editor'
                        ) {
                ...
                load: {
                    ...
                    images: function () {
                        $('#lumise-uploads div[data-tab="internal"]').trigger(
                            'scroll'
                        )
                    },
        ...
        xitems: {
            ...
            response: function (res, comp) {
                if (
                    typeof lumise.xitems.resources[comp].ops.response ==
                    'function'
                )
                ...
                if (res.items && res.items.length > 0) {
                    ...
                    html += '<span class="noitems">' + lumise.i(42) + '</span>'
                ...
                wrp.find(
                    ...
                    .on('click', function (e) {
                        ...
                        if (
                            ...
                            typeof lumise.xitems.resources[comp].ops.click ==
                                'function'
                        )
            ...
            load: function (tmp, callback) {
                ...
                if (ext == 'lumi') {
                    ...
                    templ.onerror = function () {
                        lumise.f(false)
                        lumise.fn.notice(
                            'Error on loading template file',
                            'error'
                        )
                    }
                    ...
                    if (
                        ...
                        var stage = lumise.stage(),
                            scale =
                                ...
                                stage.edit_zone.width,
                            scl =
                                stage.limit_zone.width / stage.edit_zone.width,
        ...
        cliparts: {
            ...
            add: function (el, ops) {
                ...
                if (ops.type == 'shape')
                    sto.url =
                        'data:image/svg+xml;base64,' + btoa(el.innerHTML.trim())
        ...
        tools: {
            set: function (obj) {
                ...
                el('line-height')
                    .val(
                        obj.lineHeight !== undefined ? obj.lineHeight * 10 : 10
                    )
                    .trigger('input')
                ...
                el(
                    'text-tools .text-format.lumisex-align-' + obj.textAlign
                ).addClass('selected')
                el('text-align').attr({
                    class:
                        'lumisex-align-' +
                ...
                if (obj.fontFamily) {
                    ...
                    if (
                        el('fonts').find('font[data-family="' + fml + '"]')
                            .length > 0
                    ) {
                ...
                if (obj.type == 'text-fx') {
                    ...
                    el('text-fx-offsety')
                        .val(
                            obj.bridge.offsetY !== undefined
                                ? obj.bridge.offsetY * 100
                                : 50
                        )
                        .trigger('input')
                    el('text-fx-bottom')
                        .val(
                            obj.bridge.bottom !== undefined
                                ? obj.bridge.bottom * 10
                                : 25
                        )
                        .trigger('input')
                    el('text-fx-curve')
                        .val(
                            obj.bridge.curve !== undefined
                                ? obj.bridge.curve * 10
                                : -25
                        )
                        .trigger('input')
                    ...
                    el('image-fx-brightness')
                        .val(
                            obj.fx && obj.fx.brightness ? obj.fx.brightness : 0
                        )
                        .trigger('input')
                    el('image-fx-saturation')
                        .val(
                            obj.fx && obj.fx.saturation
                                ? obj.fx.saturation
                                : 100
                        )
                        .trigger('input')
                ...
                switch (
                    ...
                    case 'oblique':
                        ...
                        $(
                            '[data-tool="text-effect"] li[data-func="text-fx"]'
                    ...
                    case 'curved':
                        ...
                        $(
                            '[data-tool="text-effect"] li[data-func="curved"]'
                        ).attr({ 'data-active': 'true' })
                        break
                    default:
                        $('[data-tool="text-effect"] li[data-func]').removeAttr(
                ...
                for (var row = 0; row < qrcode.getModuleCount(); row++) {
                    for (var col = 0; col < qrcode.getModuleCount(); col++) {
                        ctx.fillStyle = qrcode.isDark(row, col)
                            ...
                            : options.background
                        var w =
                            Math.ceil((col + 1) * tileW) -
                            Math.floor(col * tileW)
                        var h =
                            Math.ceil((row + 1) * tileW) -
                ...
                var stage = lumise.stage(),
                    ...
                    do_import = function (i) {
                        ...
                        if (data.objects[i] !== undefined) {
                            ...
                            if (data.objects[i] !== null) {
                                ...
                                if (
                                    ...
                                    if (
                                        ...
                                        data.objects[i].src.indexOf('http') !==
                                            0 &&
                                        data.objects[i].src.indexOf('blob:') !==
                                            0 &&
                                        data.objects[i].src.indexOf(
                                            'data:image/'
                                        ) !== 0
                                    )
                                        data.objects[i].src =
                                    ...
                                    var do_add = function () {
                                        ...
                                        lumise.objects.lumise[
                                            ...
                                            if (
                                                ...
                                                obj.fxOrigin =
                                                    obj._originalElement.cloneNode(
                                                        true
                                                    )
                            ...
                            if (
                                lumise.fn.url_var('print_download', '') !== ''
                            ) {
                                ...
                                $(
                                    '#lumise-print-nav button[data-func="download"]'
                                ).trigger('click')
            ...
            imports: function (data, callback) {
                ...
                if (
                    ...
                    if (lumise.data.stages[cur] && data.stages['lumise'].data) {
                        if (typeof data.stages['lumise'].data == 'string')
                            ...
                            lumise.data.stages[cur].data =
                                data.stages['lumise'].data

                        lumise.data.stages[cur].screenshot =
                            data.stages['lumise'].screenshot
                        lumise.data.stages[cur].updated =
                            data.stages['lumise'].updated
                    }
                } else {
                    this.clearAll()
                    ...
                    Object.keys(data.stages).map(function (s) {
                        ...
                        if (s == lumise.current_stage) {
                            ...
                            if (lumise.data.stages[s] !== undefined) {
                                ...
                                _stages[s].thumbnail =
                                    lumise.data.stages[s].thumbnail
                        ...
                        if (
                            ...
                            _stages[s].product_width =
                                lumise.data.stages[s].product_width
                        // _stages[s].product_width = 60;
                ...
                if (stage !== undefined && stage.data !== undefined) {
                    ...
                    if (stage.data.limit_zone !== undefined)
                        scale =
                            stage.limit_zone.width / stage.data.limit_zone.width
            ...
            lightbox: function (ops) {
                ...
                cfg.onload(tmpl)
                tmpl.find('a.kalb-close,div.kalb-overlay').on(
                    'click',
                    function (e) {
                        cfg.onclose(tmpl)
                        $('.lumise-lightbox').remove()
            ...
            svg: {
                ...
                renderColors: function (el) {
                    ...
                    inps.find('input[type="color"]').on('input', function (e) {
                        ...
                        svg.find(
                            '[fill][data-fill-attr-color="' + color + '"]'
                        ).attr({ fill: new_color })
                        svg.find(
                            '[fill][data-stroke-attr-color="' + color + '"]'
                        ).attr({ stroke: new_color })
                        svg.find(
                            '[fill][data-stop-attr-color="' + color + '"]'
                        ).attr({ 'stop-color': new_color })

                        svg.find('[data-fill-style-color="' + color + '"]').css(
                            { fill: new_color }
                        )
                        svg.find(
                            '[data-stroke-style-color="' + color + '"]'
                        ).css({ stroke: new_color })
                        svg.find('[data-stop-style-color="' + color + '"]').css(
                            { stopColor: new_color }
                        )
                    })
                ...
                replace: function (svg, new_color, color) {
                    ...
                    svg.find('[data-stroke-style-color="' + color + '"]').css({
                        stroke: new_color,
                    })
                    svg.find('[data-stop-style-color="' + color + '"]').css({
                        stopColor: new_color,
        ...
        fn: {
            ...
            reversePortView: function (eff) {
                ...
                var stage = lumise.stage(),
                    ...
                    p = {
                        ...
                        l:
                            (stage.product.left - stage.product.width / 2) *
                            ratio,
                        t:
            ...
            bridgeText: function (image, ops) {
                ...
                while (i-- > 0) {
                    if (trident) {
                        ...
                        y =
                            bottom -
                            curve * Math.sin((i * angle * Math.PI) / 180)
                    }
            ...
            image_fx: function (img, fx, callback) {
                ...
                if (
                    ...
                    fx.mask &&
                    fx.mask.dataURL &&
                    (fx.mask.image === undefined ||
                        fx.mask.image.src === undefined)
                ) {
                    ...
                    if (
                        ...
                        fx.mask.dataURL =
                            lumise.data.upload_url + fx.mask.dataURL
                ...
                return callback(
                    cv.toDataURL(),
                    lumise.fn.count_colors(cv, true)
                )
            },
            ...
            refresh_image_fx: function (active, callback) {
                ...
                lumise.ops.update_image_fx_timer = setTimeout(function () {
                    if (!active.fxOrigin || !active.fxOrigin.tagName)
                        active.fxOrigin =
                            active._originalElement.cloneNode(true)
            ...
            fill_svg: function (data, color) {
                if (
                    data.toString().indexOf('data:image/svg+xml;base64,') === -1
                )
                    return data

                var svg = atob(data.split(',')[1]),
                    span = $(
                        '<span>' + svg.substr(svg.indexOf('<svg')) + '</span>'
                    )
                ...
                if (stage.limit_zone) {
                    ...
                    Object.keys(lumise.data.stages).map(function (s) {
                        if (
                            ...
                            lumise.data.stages[s].productColor.set(
                                'fill',
                                color
                            )
            ...
            set_svg_colors: function (obj) {
                ...
                var max =
                        (lumise.get.el('svg-colors').parent().width() - 180) /
                        33,
                    ...
                    toUni = function (txt) {
                        ...
                        for (var i = 0; i < txt.length; i++) {
                            result +=
                                '&#x' +
                                (
                                    '000' + txt[i].charCodeAt(0).toString(16)
                                ).substr(-4) +
                                ';'
                        }
                        return result
                ...
                objs.map(function (o) {
                    ...
                    if (o.type == 'imagebox') {
                        ...
                        var ib_el = objs.filter(function (ie) {
                            return (
                                ie.imagebox !== undefined && ie.imagebox == o.id
                            )
                        })
                        ...
                        $(s_v)
                            ...
                            .each(function () {
                                this.setAttribute(
                                    'stroke-width',
                                    parseFloat(
                                        this.getAttribute('stroke-width') * rx
                                    )
                                )
                            })
                ...
                lumise.fn.crop({
                    ...
                    save: function (crop) {
                        ...
                        if (active) {
                            ...
                            ctx.drawImage(
                                ...
                                -_e.offsetLeft *
                                    (img.naturalWidth / _c.offsetWidth),
                                -_e.offsetTop *
                                    (img.naturalHeight / _c.offsetHeight),
                                img.naturalWidth,
                                img.naturalHeight
                            )
                        ...
                        var s = lumise.stage(),
                            ...
                            active = image,
                            img = crop.find('img.lumise_crop_img').get(0),
                            type = img.src.indexOf('data:image/jpeg')
                                ? 'jpeg'
                                : 'png',
                            canvas = document.createElement('canvas'),
                            ctx = canvas.getContext('2d'),
            ...
            update_edit_zone: function (img, stage) {
                ...
                if (ratio !== 1) {
                    stage.limit_zone.set({
                        ...
                        left:
                            stage.edit_zone.left * ratio +
                            stage.canvas.width / 2,
                        top:
                            stage.edit_zone.top * ratio +
            ...
            navigation: function (el, e) {
                ...
                if (el === 'clear' || $(el).hasClass('active')) {
                    ...
                    $('[data-navigation="active"]').attr({
                        'data-navigation': '',
                    })
                    lumise.e.main
                        .find('li[data-tool].active')
                        .removeClass('active')
                } else {
                    $('[data-navigation="active"]').attr({
                        'data-navigation': '',
            ...
            url2blob: function (dataURL) {
                if (typeof dataURL !== 'string') {
                    throw new Error(
                        'Invalid argument: dataURI must be a string'
                    )
                }
            ...
            check_upload_dimensions: function (img) {
                ...
                if (
                    ...
                    if (
                        ...
                        lumise.fn.notice(
                            lumise.i(160) +
                                ' ' +
                                lumise.data.min_dimensions.join('x'),
                            'notice',
                            3500
                        )
                        return null
                ...
                if (
                    ...
                    if (
                        ...
                        if (
                            parseFloat(lumise.data.max_dimensions[0]) <
                            img.width
                        ) {
                            ...
                            if (cv.height > lumise.data.max_dimensions[1]) {
                                cv.width =
                                    lumise.data.max_dimensions[1] *
                                    (cv.width / cv.height)
                                cv.height = lumise.data.max_dimensions[1]
                            }
                        } else if (
                            parseFloat(lumise.data.max_dimensions[1]) <
                            img.height
                        ) {
                            cv.height = parseFloat(
                                lumise.data.max_dimensions[1]
                            )
            ...
            count_colors: function (url, callback) {
                ...
                var toHex = function (c) {
                    ...
                    process = function (img, w, h) {
                        ...
                        var stats = [],
                            ctx =
                                lumise.ops.count_colors_canvas.getContext('2d')
            ...
            update_state: function () {
                ...
                lumise.ops.preventDbl = setTimeout(function () {
                    ...
                    $('#lumise-count-colors i')
                        ...
                        .attr({ title: 'Used ' + bg.length + ' colors' })
            ...
            create_canvas: function (stage, img) {
                ...
                var main = lumise.get.el('main'),
                    ...
                    mw =
                        main.width() -
                        (lumise.ops.window_width < 1025 ? 0 : 20),
                    mh =
                        main.height() -
                        (lumise.ops.window_width < 1025 ? -40 : 10)
                // console.log(img, mw, mh);exit;
                ...
                stage.lineX = $(
                    '#lumise-stage-' + name + ' .lumise-snap-line-x'
                )
                stage.lineY = $(
                ...
                ;[
                    [
                        ...
                        function (e) {
                            ...
                            if (
                                ...
                                e.layerX - disc.x - disc.w / 2 <
                                    limit.l + limit.w &&
                                e.layerY - disc.y + disc.h / 2 > limit.t &&
                                e.layerY - disc.y - disc.h / 2 <
                                    limit.t + limit.h
                            ) {
                                stage.limit_zone.set('visible', true)
                            } else {
                    ...
                    [
                        ...
                        function (e) {
                            ...
                            if (
                                !lumise.ops.drag_start ||
                                !lumise.ops.drag_start.getAttribute(
                                    'data-ops'
                                ) ||
                                stage.limit_zone.visible !== true
                            )
                    ...
                    [
                        ...
                        function (e) {
                            ...
                            if (e.shiftKey) {
                                ...
                                if (
                                    lumise.stage().canvas.isDrawingMode === true
                                ) {
                ...
                var ph = stage.canvas.height * 0.9,
                    pw =
                        product.width *
                        (stage.canvas.height / product.height) *
                        0.9
                ...
                if (
                    ...
                    (img.naturalWidth > pw || img.naturalHeight > ph)
                ) {
                    var canvas = document.createElement('canvas'),
                        ctx = canvas.getContext('2d'),
                        type = lumise.fn.get_type(img.src)
                ...
                var ez_ratio = stage.product_width
                        ? pw / stage.product_width
                        : 1,
                    editing = {
            ...
            process_variations: function (values, el) {
                ...
                let stages = lumise.ops.product_data.stages,
                    vari_data = {
                        ...
                        printings: $.extend(
                            true,
                            [],
                            lumise.ops.product_data.printings
                        ),
                        attributes: $.extend(
                            true,
                            {},
                ...
                Object.keys(varis.variations).map(function (v) {
                    ...
                    Object.keys(varis.variations[v].conditions).map(function (
                        c
                    ) {
                        ...
                        if (
                            ...
                            (varis.variations[v].conditions[el.name] == '' || // condition attr c is any
                                ...
                                varis.variations[v].conditions[el.name] ==
                                    values[el.name]) &&
                            ...
                            if (varis.variations[v].conditions[c] !== '')
                                ...
                                typeof vari_data.attributes[c].values ==
                                    'object' &&
                                typeof vari_data.attributes[c].values.options ==
                                    'object'
                            ) {
                                // if condition of variation is any, set allow all options of attr

                                vari_data.attributes[c].values.options.map(
                                    function (op) {
                                        if (
                                            vari_data.attributes[
                                                c
                                            ].allows.indexOf(op.value) === -1
                                        )
                                            vari_data.attributes[c].allows.push(
                                                op.value
                                            )
                                    ...
                                    vari_data.attributes[c].values.options.map(
                                        function (op) {
                                            if (
                                                vari_data.attributes[
                                                    c
                                                ].allows.indexOf(op.value) ===
                                                -1
                                            )
                                                vari_data.attributes[
                                                    c
                                                ].allows.push(op.value)
                                        }
                                    )
                                }
                            } else if (
                ...
                if (obj !== null) {
                    ;['price', 'sku', 'description', 'minqty', 'maxqty'].map(
                        function (p) {
                            if (
                                obj[p] !== undefined &&
                                obj[p] !== null &&
                    ...
                    if (
                        ...
                        obj['printings'].map(function (p) {
                            if (
                                p['calculate'] &&
                                typeof p['calculate'] == 'string'
                            )
                                p['calculate'] = lumise.fn.dejson(
                                    p['calculate']
                                )
                        })
                        vari_data['printings'] = $.extend(
                            true,
                            [],
                            obj['printings']
                        )
            ...
            keep_current_designs: function (new_stages) {
                ...
                Object.keys(curent_designs).map(function (c, i) {
                    if (typeof curent_designs[c].data == 'string')
                        curent_designs[c].data = JSON.parse(
                            curent_designs[c].data
                        )
            ...
            preview_designs: function () {
                lumise.get
                    .el('stage-nav')
                    .addClass('stages-expand preview-designs')
            },
            ...
            load_product: function (ops) {
                ...
                donow = function (res) {
                    ...
                    if (res.variations.variations) {
                        Object.keys(res.variations.variations).map(function (
                            v
                        ) {
                            res.variations.variations[v].printings.map(
                                function (p) {
                    ...
                    .each(function (i) {
                        ...
                        if (stage.canvas) {
                            ...
                            lumise.data.stages[s].screenshot =
                                data.stages[s].screenshot
                            // lumise.data.stages[s].screenshot = 33;
            ...
            scale_designs: function (scale, pos) {
                ...
                scale =
                    scale *
                    (stage.limit_zone.width / (stage.limit_zone.width - bd))
                ...
                var xl =
                        (stage.limit_zone.width - bd) / 2 +
                        stage.limit_zone.left,
                    yl =
                        (stage.limit_zone.height - bd) / 2 +
                        stage.limit_zone.top,
            ...
            clear_url: function (ex) {
                ;['car', 'design_print', 'order_print', 'design', 'share'].map(
                    function (i) {
            ...
            do_double: function () {
                var canvas = lumise.stage().canvas,
                    ...
                    do_clone = function (ids) {
                        ...
                        canvas.getObjects().map(function (obj) {
                            ...
                            clone.left =
                                ((group ? group.left : 1) + obj.left) * 1.1
                            clone.top =
                                ((group ? group.top : 1) + obj.top) * 1.1
                ...
                if (active) {
                    ...
                    lumise.tools.discard()
                    clearTimeout(lumise.ops.preventDbl)
                    lumise.ops.preventDbl = setTimeout(do_clone, 100, [
                        active.id,
                    ])
                } else if (group) {
                    return
                    ...
                    var ids = []
                    group._objects.map(function (o) {
                        if (o.id && ids.indexOf(o.id) === -1) ids.push(o.id)
                    })
            ...
            build_lumi: function (img) {
                ...
                var urldata = cv.toDataURL(
                        'image/' +
                            (img.src.indexOf('.png') > -1 ? 'png' : 'jpeg')
                    ),
                    data = {
                        stages: {
                            lumise: {
            ...
            crop: function (ops) {
                ...
                crop.on('mousedown touchstart', function (e) {
                    ...
                    var ratio = img.width / img.naturalWidth,
                        ...
                        lock_dimension = lightbox
                            ...
                            .hasClass('active'),
                        dimension =
                            ops.dimension !== undefined ? ops.dimension : 0 // width:height
                    ...
                    var dark_zone = function () {
                        ...
                        i.html(
                            Math.round(o.w / ratio) +
                                ' x ' +
                                Math.round(o.h / ratio)
                        )
                    }
                ...
                crop.find('img.lumise_crop_img').on('load', function () {
                    ...
                    if (!s.active.fx || !s.active.fx.crop) {
                        ...
                        p = {
                            width:
                                this.offsetWidth * s.active.fx.crop.width +
                                'px',
                            height:
                                this.offsetHeight * s.active.fx.crop.height +
                                'px',
                            left:
                                this.offsetWidth * s.active.fx.crop.left + 'px',
                            top:
                                this.offsetHeight * s.active.fx.crop.top + 'px',
                        }
                    }
                ...
                $(
                    '#lumise-lightbox-content .lumise-crop-btns li[data-func]'
                ).on('click', function (e) {
                    var func = this.getAttribute('data-func'),
                        el = crop.find('.lumise_crop_selArea')
            ...
            large_image_helper: function (op) {
				...
				*/
                ...
                var src = canvas.toDataURL(
                    'image/' +
                        (op.src.indexOf('image/png') > -1 ||
                        op.src.indexOf('.png') > -1
                            ? 'png'
                            : 'jpeg')
                )
            ...
            uncache_large_images: function (callback, revert) {
                ...
                // $('#LumiseDesign').attr({'data-processing': 'true', 'data-msg': '取消缓存处理..'});
                $('#LumiseDesign').attr({
                    'data-processing': 'true',
                    'data-msg': '请稍候..',
                })
                ...
                var s = lumise.stage(),
                    ...
                    process = function () {
                        ...
                        // console.log(obj.full_src, obj.type);exit;
                        if (
        ...
        render: {
            colorPresets: function () {
                ...
                if (
                    lumise.data.enable_colors != '0' &&
                    localStorage.getItem('lumise_color_presets')
                ) {
                    colors = localStorage
                ...
                el.find('li').on('click', function () {
                    var el = lumise.get.el(
                        $(this)
                            .closest('ul.lumise-color-presets')
                            .data('target')
                    )
            ...
            my_designs: function (design) {
                ...
                if (
                    lumise.fn.version_compare('1.7.1', design.system_version) >
                    0
                ) {
                ...
                design.screenshot =
                    typeof design.screenshot == 'string'
                        ? URL.createObjectURL(
                              lumise.fn.url2blob(design.screenshot)
                          )
                        : lumise.data.assets +
            ...
            shapes: function (data) {
                if (
                    lumise.get.el('shapes').find('ul.lumise-list-items')
                        .length === 0
                ) {
                    lumise.get
                        .el('shapes')
            ...
            fonts: function (fonts) {
                ...
                window.lumise_render_text = function (family, font) {
                    if (
                        $('#lumise-text-ext li[data-family="' + family + '"]')
                            .length > 0
                    )
                        return
                    ...
                    var el = $(
                        '<span data-family="' +
                            ...
                            'data-ops=\'[{"type":"i-text", "fontSize": "30", "fontFamily": "' +
                            family +
                            '", ' +
                            (font !== undefined
                                ? '"font": "' + font.replace('\\', '/') + '",'
            ...
            stage_nav: function () {
                ...
                $('#lumise-stage-nav ul').sortable({
                    ...
                    beforeStop: function () {
                        var _stages = {}
                        $('#lumise-stage-nav ul li[data-stage]').each(
                            function () {
            ...
            product: function (data, callback, designs) {
                ...
                var variations =
                    data.variations !== undefined ? data.variations : {}
                ...
                lumise.active_stage(lumise.render.stage_nav(), function () {
                    ...
                    // hash : 5fecb5125fdb9c9cf8f2e54802cfb020
                        ...
                        sessionStorage.getItem('kLUMISE-START-NEW') === true
                    ) {
            ...
            cart_details: function (e) {
                    ...
                    Object.keys(items).map(function (id) {
                        ...
                        Object.keys(item.options).map(function (at) {
                            ...
                            if (
                                ...
                                typeof item.attributes[at].values == 'object'
                            ) {
                                val = lumise.fn.attr_label(
                                    val,
                                    item.attributes[at].values
                                )
                            }
                ...
                lumise.trigger({
                    ...
                    events: {
                        ...
                        'tfoot button.lumise-btn-primary':
                            lumise.cart.do_checkout,
                    },
                    ...
                    remove_item: function (e) {
                        if (confirm(lumise.i('sure'))) {
                            var id = this.getAttribute('data-id'),
                                total_elm = $('#lumise-cart-details').find(
                                    'tfoot tr:first td'
                                ),
                                total = 0
            ...
            categories: function (type, res) {
                var btn = $(
                    'button[data-func="show-categories"][data-type="' +
                        type +
                        '"]'
                )
                ...
                if (items === undefined || items.length === 0)
                    ...
                    items.map(function (item) {
                        ...
                        if (
                            ...
                            thumbn =
                                lumise.data.upload_url + 'thumbnails/' + thumbn
                        html +=
                    ...
                    lumise.data.access_core.split(',').map(function (a) {
                        if (
                            ...
                            try {
                                ...
                                console.warn(
                                    'Error on lumise addon callback "' +
                                        a +
                                        '": ' +
                                        ex.message
                                )
        ...
        response: {
            ...
            edit_design: function (res) {
                ...
                if (
                    window.location.href.indexOf('design=' + res.id + '&') ===
                    -1
                ) {
            ...
            delete_design: function (res) {
                ...
                $(
                    'ul#lumise-saved-designs li[data-id="' + res.id + '"]'
                ).remove()
            ...
            list_products: function (res) {
                ...
                var cates = [
                        '<ul data-view="categories" style="display: none">',
                        '<h3>' + lumise.i(56) + '</h3>',
                        '<li data-id="" ' +
                ...
                if (res.products && res.products.length > 0) {
                    res.products.map(function (p) {
                        ...
                        var cates = '',
                            color =
                                p.stages.options !== undefined
                                    ? p.stages.options.color
                                    : p.stages.colors !== undefined
                                    ? p.stages.colors.active
                        ...
                        if (p.xy_id > 303) {
                            p_img =
                                'http://qnimg.weiladiy.com/' + p.product_logo
                        }
                        prods.push(
                            '<li data-id="' +
                                p.id +
                                '"' +
                                (lumise.data.product == p.id
                                    ? ' data-current="true"'
                                    : '') +
                                ' data-name="' +
                                p.product_name
                    ...
                    prods.push(
                        '<li data-view="noitem">' + lumise.i(42) + '</li>'
                    )
				...
				*/
                ...
                lumise.trigger({
                    ...
                    product: function () {
                        ...
                        var id = this.getAttribute('data-id'),
                            product = lumise.ops.products.products.filter(
                                function (p) {
                                    return p.id == id
                                }
                            )
                    ...
                    search: function (e) {
                        ...
                        e.data.el
                            .find(
                                'ul[data-view="categories"] li[data-id="all"]'
                            )
                            .addClass('active')
        ...
        mobile: function (canvas_view) {
            ...
            if (ww < 1025) {
                ...
                $('#lumise-main')
                    .on('mousedown touchstart', function (e) {
                        ...
                        this._do =
                            $('#lumise-top-tools').attr('data-view') ==
                            'standard'
            ...
            if (ww < 450) {
                ...
                $(
                    'div#lumise-left>div.lumise-left-nav-wrp,div#lumise-stage-nav'
                ).css({ top: wh + 'px' })
        ...
        active_stage: function (name, callback) {
            ...
            if (stage.size !== undefined && stage.size !== '') {
                if (typeof stage.size == 'string') {
                    ...
                    nav.find('select[name="select-size"]')
                        .val(stage.size)
                        .attr({ disabled: true })
                    ...
                    nav.find('input[name="size"]')
                        .val(stage.size.width + ' x ' + stage.size.height)
                        .attr({ disabled: true })
                    nav.find('input[data-unit="' + stage.size.unit + '"]').prop(
                        { checked: true }
                    )
                ...
                if (pcfg && pcfg !== '') {
                    pcfg = JSON.parse(pcfg)
                    if (pcfg.format !== undefined)
                        nav.find('input[data-format="' + pcfg.format + '"]')
                            .prop({ checked: true })
                            .change()
                    if (pcfg.unit !== undefined)
                        nav.find('input[data-unit="' + pcfg.unit + '"]')
                            .prop({ checked: true })
                            .change()
                    if (pcfg.size !== undefined)
                        nav.find('select[name="select-size"]')
            ...
            if (stage.canvas) {
                ...
                lumise.fn.stage_nav(
                    name,
                    stage.product.width / stage.product.height
                )
            ...
            fabric.util.loadImage(stage.image, function (img) {
                ...
                if (img === null) {
                    ...
                    image.onload = function () {
                        lumise.fn.create_canvas(stage, image)
                        stage.canvas.renderAll()
        ...
        cart: {
            ...
            sum_calc: function () {
                var prices = {},
                    extra_filter = lumise.apply_filters(
                        'product_extra_price',
                        {}
                    ),
                    price =
                ...
                var ext_price = Object.values(extra_filter).filter(
                    (price) =>
                        typeof price !== 'object' && parseFloat(price) > 0
                )

                if (ext_price.length > 0)
                    price += ext_price.reduce(
            ...
            get_price: function (f) {
                ...
                price =
                    (sum + lumise.cart.printing.calc(lumise.cart.qty)) *
                    lumise.cart.qty
            ...
            add_cart: function (e) {
                ...
                if (
                    ...
                    $('.lumise-prints')
                        .find(
                            '.lumise-cart-field-printing-tmpl .lumise-required-msg'
                        )
                        .html(lumise.i(99))
                }
                ...
                attrs.find('.lumise-cart-param').each(function (ind) {
                    ...
                    if (field.prop('required')) {
                        if (
                            ...
                            invalids.push(name)
                            invalid_fields.push(
                                field.closest('.lumise-cart-field')[0]
                            )
                            field
                                .after(
                ...
                if (invalid_fields.length > 0) {
                    ...
                    if (wrp.closest('#lumise-product').length > 0) {
                        $(
                            '#lumise-left .lumise-left-nav li[data-tab="product"]'
                        ).trigger('click')
                        $('#lumise-product')
                            .show()
                ...
                try {
                    ...
                    if (parseFloat(lumise.cart.qty) < parseFloat(vari.minqty)) {
                        ...
                        parseFloat(lumise.cart.qty) > parseFloat(vari.maxqty)
                    ) {
                        lumise.fn.notice(
                            lumise.i(150) +
                                ' <br>(Variation #' +
                            ...
                            lumise.fn.uncache_large_images(function () {
                                ...
                                lumise.fn.download_design({
                                    ...
                                    callback: function (data) {
                                        ...
                                        // console.log(Object.keys(lumise.data.stages)[start_render])
                                        if (
            ...
            variations: function (el) {
                ...
                if (vari_data.cfgprinting)
                    ...
                    lumise.data.printings_cfg =
                        lumise.ops.product_data.printings_cfg
                ...
                fields.map(function (field) {
                    ...
                    if (field.value === '') {
                        ...
                        if (lumise.cart.data.options[attr.id] === undefined)
                            ...
                            lumise.cart.data.options[attr.id] +=
                                '\n' + field.value
                    }
                    ...
                    if (attr.type == 'quantity') {
                        if (!isNaN(parseInt(field.value))) {
                            ...
                            if (
                                ...
                                var attr_price =
                                    attr.values.package_options.filter(
                                        function (o) {
                                ...
                                if (
                                    ...
                                    lumise.cart.price.attr += parseFloat(
                                        attr_price[0].price
                                    )
                                }
                            }
                            ...
                            try {
                                ...
                                Object.keys(qtys).map(function (i) {
                                    var attr_price =
                                        attr.values.multiple_options.filter(
                                            function (o) {
                                                return o.value == i
                                            }
                                        )
                        ...
                        field.value.split(decodeURI('%0A')).map(function (v) {
                            ...
                            attr_price = attr.values.options.filter(function (
                                o
                            ) {
                                return o.value == v
                            })
                    ...
                    if (typeof lumise.data.stages[s].canvas !== 'undefined') {
                        ...
                        canvas.getObjects().map(function (obj) {
                            ...
                            if (
                                ...
                                lumise.cart.template[s].indexOf(
                                    obj.template[0]
                                ) === -1
                            ) {
            ...
            checkout: function (data) {
                ...
                $.ajax({
                    ...
                    xhr: function () {
                        ...
                        xhr.upload.addEventListener(
                            ...
                            function (evt) {
                                if (evt.lengthComputable) {
                                    var percentComplete = parseFloat(
                                        evt.loaded / evt.total
                                    ).toFixed(2)

                                    if (percentComplete < 1) {
                                        var this_num_now = parseInt(
                                            percentComplete * 100
                                        )
                                        // console.log(this_num_now);
                                        $('div#LumiseDesign').attr({
                                            'data-msg': this_num_now + '% ',
                                        })
                                        // $('div#LumiseDesign').attr({'data-msg': '下载完成：'.parseInt(percentComplete*100)+'% '});
                                        // $('div#LumiseDesign').attr({'data-msg': parseInt(percentComplete*100)+'% upload complete'});
                                    } else {
                ...
                $.ajax({
                    ...
                    url:
                        lumise.data.ajax +
                        '&action=upload&ajax=frontend&nonce=LUMISE-SECURITY:' +
                        lumise.data.nonce,
                    xhr: function () {
                        var xhr = new window.XMLHttpRequest()
                        xhr.upload.addEventListener(
                            ...
                            function (evt) {
                                if (evt.lengthComputable) {
                                    ...
                                    // var percentComplete = parseFloat(evt.loaded / evt.total).toFixed(2);
                                    //
                                    // if (percentComplete < 1){
                                    //   var this_num_now = parseInt(percentComplete*100);
                                    //   // console.log(this_num_now);
                                    //   $('div#LumiseDesign').attr({'data-msg': this_num_now+'% '});
                                    //   // $('div#LumiseDesign').attr({'data-msg': '下载完成：'.parseInt(percentComplete*100)+'% '});
                                    //   // $('div#LumiseDesign').attr({'data-msg': parseInt(percentComplete*100)+'% upload complete'});
                                    //
                                    // } else {
                ...
                lumise.trigger({
                    ...
                    formula: function (e) {
                        ...
                        if (lumise.data.printings.length > 0) {
                            var print = lumise.data.printings.filter(function (
                                p
                            ) {
                        ...
                        <tr>\
                            <td style="width:20%;text-align: left">' +
                                ...
                                lumise.cart.qty +
                                'qty = <strong>' +
                                lumise.fn.price(item_price * lumise.cart.qty) +
                                '</strong></td>\
										</tr>\
										' +
                                (lumise.cart.price.fixed !== 0
                                    ? '\
                                      ...
                                      lumise.i(74) +
                                      ' + ' +
                                      lumise.fn.price(lumise.cart.price.fixed) +
                                      ' = <strong>' +
                                      lumise.fn.price(
                ...
                lumise.trigger({
                    ...
                    submit_cart: function (e) {
                        ...
                        form.find('input[name=data]').val(
                            JSON.stringify(lumise.cart.data)
                        )
            ...
            fields: {
                render: function (data) {
                    ...
                    if (data.use_variation === true) {
                        ...
                        data.values = {
                            options: [
                                { value: '', title: lumise.i(178), price: '' },
                            ],
                        }
                    }
            ...
            printing: {
                ...
                render: function (active) {
                    ...
                    lumise.data.printings.map(function (print, index) {
                        print.thumbnail =
                            print.thumbnail ||
                            lumise.data.assets +
                                'assets/images/print-default.jpg'

                        var id = 'lumise-printing-' + print.id,
                            show_link =
                                print.description !== '' ||
                                (typeof print.calculate['show_detail'] !==
                                    'undefined' &&
                                    print.calculate.show_detail == 1)
                                    ? true
                                    : false,
                        ...
                        if (
                            sessionStorage.getItem('LUMISE-PRINT-DROPDOWN') ===
                            'false'
                        ) {
                    ...
                    if (
                        ...
                        lumise.cart.printing.current =
                            lumise.data.printings[0].id
                    }

                    if (lumise.cart.printing.current !== null)
                        $(
                            '#lumise-printing-' + lumise.cart.printing.current
                        ).trigger('click')
                },
                ...
                calc: function (qty) {
                    ...
                    var match_print = lumise.data.printings.filter(function (
                        p
                    ) {
                    ...
                    try {
                        ...
                        var data = JSON.parse(
                            ...
                            get_design = function (res) {
                                ...
                                // console.log(lumise.apply_filter('custom-checkout',false))
                                if (count === Object.keys(data).length) {
                                    if (
                                        ...
                                        //到这里面11
                                        // console.log(lumise.apply_filters('checkout', data));exit;
                                        lumise.actions.do(
                                            'checkout',
                                            lumise.apply_filters(
                                                'checkout',
        ...
        load: function () {
            ...
            this.actions.add('object:added', function (opts) {
                ...
                if (
                    obj.origin_src === undefined &&
                    obj._element &&
                    obj._element
                )
                    obj.set('origin_src', obj._element.src)

                if (obj.type == 'i-text') obj.set('padding', 5)
                        ...
                        lumise.fn.createThumbn({
                            ...
                            callback: function (canvas) {
                                ...
                                if (obj.colors === undefined)
                                    obj.set(
                                        'colors',
                                        lumise.fn.count_colors(canvas, true)
                                    )
                            },
                        })
            ...
            this.actions.add('active_stage', function () {
                ...
                if (
                    typeof lumise.cart.printing.states_data[
                        lumise.current_stage
                    ] !== 'undefined'
                ) {
                    var stage_colors =
                        lumise.cart.printing.states_data[lumise.current_stage]
                            .colors
                    for (var i = 0; i < 6; i++) {
            ...
            ;[
                ...
                lumise.actions.add(k[0], function (e) {
                    lumise.get
                        .el('navigations')
                        .find(
                            'li[data-tool="file"] li[data-func="' + k[1] + '"]'
                        )
                        .trigger('click')
                    e.preventDefault()
                    e.stopPropagation()
            ...
            CanvasRenderingContext2D.prototype.roundRect = function (
                ...
                if (w < 1.75 * r) r = w / 1.75
                if (h < 1.75 * r) r = h / 1.75
                    ...
                    switch (e.data.action) {
                        ...
                        case 'import_image':
                            ...
                            if (e.data.ops.name.indexOf('/') > -1)
                                e.data.ops.name = e.data.ops.name
                                    .split('/')
                                    .pop()
