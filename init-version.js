						...
						if (data.objects[i] !== undefined) {
							...
							if (data.objects[i] !== null) {
								...
								if (lumise.objects.lumise[data.objects[i].type]) {
									...
									var do_add = function() {
debugger;
										// console.log(22,lumise.data.stages)
			...
			update_state : function() {
				...
				lumise.ops.preventDbl = setTimeout(function() {
					...
					var states = {},
						...
						colors = [],
						c;
// console.log(lumise.data.stages);return;
					Object.keys(lumise.data.stages).map(function(s){
...
// alert(4)
		...
		active_stage : function(name, callback) {
			...
			console.log(this.data.stages,this.current_stage)
...
debugger
						...
						if (stage.data) {
							...
							console.log(7747)
							lumise.tools.import(stage.data, function(){
								// console.log(555,stage.data); return;
								// console.log(6)
								if (scale !== 1)
									lumise.fn.scale_designs(scale);
								lumise.stack.save();
...
console.log(55,id,cart_design)
				...
				$.ajax({
					...
					data: {
						...
						cart_design:JSON.stringify(cart_design),
