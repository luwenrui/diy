    ...
    window.lumise = {
        ...
        render: {
            colorPresets: function () {
                if (lumise.data.status == 1) {
                    window.location.href =
                        'http://diy.cmygx.cn/index.php?s=/store/index/index'
                    exit
                }
				...
				*/
                ...
                $('#lumise-cart-action1').on('click', function (e) {
                    function preview() {
                        ...
                        //     is_child:  lumise.fn.sgetQueryString('is_child'),
                        //     this_id: [],
                        //     img: [],
                        // }
                        // const ops = {
                        ...
                        //     cache: true,
                        //     type: 'POST',
                        //     url: 'http://diy.cmygx.cn/index.php?s=/store/goods.category1/ajax_get_psd',
                        //     data: base64Arr,
                        //     async: false,
                        //     success: function (res, status) {
                        ...
                        //         case 'svg':
                        //             var svg_obj =
                        //                 lumise.fn.export_svg(include_base)
